                ...
                <div className='w-full md:w-[40%] relative'>
                    <motion.div variants={svgVariants} initial="hidden" animate="visible" className="z-[-1] absolute w-full flex justify-center stroke-[orange]">
                        <motion.svg variants={svgVariants} width="300px" height="300px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <motion.path initial={{ pathLength: 0 }} animate={isInView && { pathLength: 1 }} transition={{ duration: 3 }} d="M13.5 2C13.5 2 15.8335 2.21213 18.8033 5.18198C21.7731 8.15183 21.9853 10.4853 21.9853 10.4853" strokeWidth={1.5} strokeLinecap={"round"} />
                            <motion.path initial={{ pathLength: 0 }} animate={isInView && { pathLength: 1 }} transition={{ duration: 3 }} d="M14.207 5.53564C14.207 5.53564 15.197 5.81849 16.6819 7.30341C18.1668 8.78834 18.4497 9.77829 18.4497 9.77829" strokeWidth={1.5} strokeLinecap={"round"} />
