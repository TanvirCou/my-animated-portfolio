...
const Contact = () => {
    ...
    return (
        <motion.div ref={ref} variants={textVariants} initial="hidden" whileInView="visible" className='w-full flex justify-center items-center h-screen'>
            <motion.div variants={textVariants} className='flex max-md:flex-col gap-y-10 w-[90%] sm:w-[70%] md:w-[90%] xl:w-[82%] items-center justify-center gap-x-8'>
                <motion.div variants={textVariants} className='w-full md:w-[40%] flex flex-col text-center md:text-start gap-y-6'>
                    ...
                    <motion.div variants={textVariants}>
                        ...
                        <p className='text-sm'>+800-1859594373</p>
                    </motion.div>
                </motion.div>
                <div className='w-full md:w-[40%] relative'>
                    <motion.div variants={svgVariants} initial="hidden" animate="visible" className="z-[-1] absolute w-full flex justify-center stroke-[orange]">
                        <motion.svg variants={svgVariants} width="300px" height="300px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <motion.path initial={{ pathLength: 0 }} animate={isInView && { pathLength: 1 }} transition={{ duration: 3 }} d="M13.5 2C13.5 2 15.8335 2.21213 18.8033 5.18198C21.7731 8.15183 21.9853 10.4853 21.9853 10.4853" stroke-width="1.5" stroke-linecap="round" />
                            <motion.path initial={{ pathLength: 0 }} animate={isInView && { pathLength: 1 }} transition={{ duration: 3 }} d="M14.207 5.53564C14.207 5.53564 15.197 5.81849 16.6819 7.30341C18.1668 8.78834 18.4497 9.77829 18.4497 9.77829" stroke-width="1.5" stroke-linecap="round" />
